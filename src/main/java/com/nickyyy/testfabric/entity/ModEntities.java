...
public class ModEntities {
    ...
    public static final BlockEntityType<CopperCableEntity> COPPER_CABLE_ENTITY =
            FabricBlockEntityTypeBuilder.create(CopperCableEntity::new, ModBlocks.COPPER_CABLE).build();
